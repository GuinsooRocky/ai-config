...
## 结账与人工闸（2026-08-06 体检立法）

- **销账即回勾**：报告「已合 main / 已上线 / 已修完」的同一轮顺手关账——BACKLOG 勾掉、记忆假待办删掉、人工闸清单销掉；账本只会单向高估欠债（详见 memory: feedback_ledger_close_on_done.md）
- **人工闸清单**（只有用户本人能做的活：真机验收/花真钱/外部授权/部署占位符/人工标注）单一真相 = `~/Desktop/archives/self/人工闸.md`；发现新的这类活 → 追加进清单并提一句，别只留在对话里
- rhythm-guard hook 会在每周首次开工注入清单提醒、凌晨 3 点后注入熔断提醒——收到就原样转达给用户，别吞
