...
crushon-admin 封板→上 pre 的完整 runbook 落在 **`~/Desktop/cmm/onlychat-World-Path/crushon-admin上pre流程.md`**，接到「admin 上 pre」任务先读它。
...
相关：[[feedback_project_intel_stays_in_project_docs]]（全文按此规矩落项目文档，memory 只留本指针）
