...
- ~~creator_id 迁移 dry-run 备好等放行~~ → **07-11 就洗完了**，官方卡 993 张全归位、dry-run 实跑「洗定集 0」（08-04 体检进仓证实；PRD 里「361 张待洗」是过时估数）
- ~~T36 种子卡换图挂账中~~ → **owner 拍的是不做**，DONE.md 标 `[skip]`，4979 张图早已全在自有 R2（08-04 体检进仓证实）
