---
name: video
description: Extract transcripts and produce structured summaries from supported video
  or podcast links. Use for YouTube, Bilibili, X video, podcast, or local media transcription
  tasks.
---
