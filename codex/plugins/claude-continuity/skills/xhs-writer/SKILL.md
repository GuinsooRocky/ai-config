...
| 用户的话 | 走哪条 | 怎么做 |
|---|---|---|
| 写公众号文章 / 长文 / 续写扩写 | **公众号长文** | 走下面「核心价值观 → 第一步~第四步」完整流程 |
...
触发词：写文章、写稿子、帮我写、续写、扩写、公众号长文、出稿、按我的风格写、做成小红书、出小红书、根据 idea/文档出小红书、小红书 9 图、改小红书帖、去 AI 味、去 khazix、改得不像 AI 写的、这段太 AI 了、挖选题、小红书选题、今天有啥可发的、复盘笔记数据。
...
**通过标准**：L3-1和L3-2必须全部通过，L3-3至L3-6中至少通过相关项（按文章类型判断适用性，不适用的项直接跳过并注明）。
